...
- [x] Phase 3: enemy coordinator + mission 8系統データ定義
- [ ] Phase 4: Hub 完成 + Ember Ossuary + Moon Reservoir
...
- [x] enemy pressure と mission variety の基盤をデータ駆動で実装
- [ ] campaign クリア可能状態
...
## 既知 blocker
- EncounterDirector 本体、room graph、relic/reward 本実装が未着手
